...
<div class="entry sitemap">
	...
	<?php 
		...
		foreach($post_types as $post_type):		
			...
			{
				$cat_taxonomies = 	$taxonomies[1];
			}
			else
			{
				$cat_taxonomies  = $taxonomies[0];
			}
	...
	?>
	  ...
	  <?php } ?>
       <!--/arclist -->
	   <?php 
		$WPListCustomCategories = wp_list_categories('title_li=&hierarchical=0&show_count=0&echo=0&taxonomy='.$cat_taxonomies);
