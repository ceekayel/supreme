...
get_header(); // Loads the header.php template. ?>
	...
	<div id="content">
		...
		<div class="hfeed">
			...
			<div class="loop-meta">
				<?php if (is_search()) : ?>
					<h1 class="loop-title"><?php _e('Search Results:', 'supreme'); ?> &ldquo;<?php the_search_query(); ?>&rdquo; <?php if (get_query_var('paged')) echo ' &mdash; Page '.get_query_var('paged'); ?></h1>
				<?php else : ?>
					<h1 class="loop-title"><?php _e('All Products', 'supreme'); ?></h1>
				<?php endif; ?>
			</div><!-- .loop-meta -->
