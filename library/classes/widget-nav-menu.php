...
class Hybrid_Widget_Nav_Menu extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname' => 'nav-menu',
			'description' => esc_html__( 'An advanced widget that gives you total control over the output of your menus.', 'supreme' )
		);
		...
		$this->WP_Widget(
			...
			__( 'Navigation Menu', 'supreme' ),	// $this->name
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Navigation', 'supreme' ),
			'menu' => '',
			'container' => 'div',
			'container_id' => '',
			'container_class' => '',
