...
class Hybrid_Widget_Categories extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'An advanced widget that gives you total control over the output of your category links.', 'supreme' )
		);
		...
		$this->WP_Widget(
			...
			__( 'Categories', 'supreme' ),	// $this->name
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Categories', 'supreme' ),
			'taxonomy' => 'category',
			'style' => 'list',
			'include' => '',
			'exclude' => '',
		...
		$style = array( 'list' => esc_attr__( 'List', 'supreme' ), 'none' => esc_attr__( 'None', 'supreme' ) );
		$order = array( 'ASC' => esc_attr__( 'Ascending', 'supreme' ), 'DESC' => esc_attr__( 'Descending', 'supreme' ) );
		$orderby = array( 'count' => esc_attr__( 'Count', 'supreme' ), 'ID' => esc_attr__( 'ID', 'supreme' ), 'name' => esc_attr__( 'Name', 'supreme' ), 'slug' => esc_attr__( 'Slug', 'supreme' ), 'term_group' => esc_attr__( 'Term Group', 'supreme' ) );
		$feed_type = array( '' => '', 'atom' => esc_attr__( 'Atom', 'supreme' ), 'rdf' => esc_attr__( 'RDF', 'supreme' ), 'rss' => esc_attr__( 'RSS', 'supreme' ), 'rss2' => esc_attr__( 'RSS 2.0', 'supreme' ) );
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['use_desc_for_title'], true ); ?> id="<?php echo $this->get_field_id( 'use_desc_for_title' ); ?>" name="<?php echo $this->get_field_name( 'use_desc_for_title' ); ?>" /> <?php _e( 'Use description?', 'supreme' ); ?> <code>use_desc_for_title</code></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_count'], true ); ?> id="<?php echo $this->get_field_id( 'show_count' ); ?>" name="<?php echo $this->get_field_name( 'show_count' ); ?>" /> <?php _e( 'Show count?', 'supreme' ); ?> <code>show_count</code></label>
		</p>
		<p>
