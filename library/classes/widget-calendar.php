...
class Hybrid_Widget_Calendar extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname' => 'calendar',
			'description' => esc_html__( 'An advanced widget that gives you total control over the output of your calendar.', 'supreme' )
		);
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Calendar', 'supreme' ),
			'initial' => false
		);
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'initial' ); ?>"><?php _e( 'One-letter abbreviation?', 'supreme' ); ?> <code>initial</code></label>
		</p>
		</div>
	<?php
	}
