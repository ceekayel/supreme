...
add_action('wp_head','supreme_custom_background_callback');
/**
...
if(!function_exists('___templatic_wp_whitespace_fix')){
	function ___templatic_wp_whitespace_fix( $input ) {
		return preg_replace( '/^\s*<\?xml/', '<?xml', $input );
	}
	ob_start( '___templatic_wp_whitespace_fix' );
}
?>