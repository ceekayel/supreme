...
<form id="bbp-your-profile" action="<?php bbp_user_profile_edit_url( bbp_get_displayed_user_id() ); ?>" method="post">
	...
	<div class="bbp-form">
		<h3><?php _e( 'Name', 'supreme' ) ?></h3>

		<?php do_action( 'bbp_user_edit_before_name' ); ?>

		<p>
			<label for="first_name"><?php _e( 'First Name', 'supreme' ) ?></label><br />
		...
		<p>
			<label for="last_name"><?php _e( 'Last Name', 'supreme' ) ?></label><br />
		...
		<p>
			<label for="nickname"><?php _e( 'Nickname', 'supreme' ); ?></label><br />
		...
		<p>
			<label for="display_name"><?php _e( 'Display name publicly as', 'supreme' ) ?></label>
		...
		<h3><?php _e( 'Contact Info', 'supreme' ) ?></h3>

		<?php do_action( 'bbp_user_edit_before_contact' ); ?>

		<p>
			<label for="url"><?php _e( 'Website', 'supreme' ) ?></label><br />
		...
		<h3><?php bbp_is_user_home() ? _e( 'About Yourself', 'supreme' ) : _e( 'About the user', 'supreme' ); ?></h3>

		<?php do_action( 'bbp_user_edit_before_about' ); ?>

		<p>
			<label for="description"><?php _e( 'Biographical Info', 'supreme' ); ?></label><br />
			...
			<span class="description"><?php _e( 'Share a little biographical information to fill out your profile. This may be shown publicly.', 'supreme' ); ?></span>
		</p>

		<?php do_action( 'bbp_user_edit_after_about' ); ?>
	
		<h3><?php _e( 'Account', 'supreme' ) ?></h3>
		...
		<p>
			...
			<span class="description"><?php _e( 'Usernames cannot be changed.', 'supreme' ); ?></span>
		</p>

		<p>
			<label for="email"><?php _e( 'Email', 'supreme' ); ?></label><br />
			...
			<span class="description updated">
				<?php printf( __( 'There is a pending email address change to <code>%1$s</code>. <a href="%2$s">Cancel</a>', 'supreme' ), $new_email['newemail'], esc_url( self_admin_url( 'user.php?dismiss=' . bbp_get_current_user_id()  . '_new_email' ) ) ); ?>
			</span>
		...
		<p>
			<label for="pass1"><?php _e( 'New Password', 'supreme' ); ?></label><br />
			<input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" tabindex="<?php bbp_tab_index(); ?>" />
			<span class="description"><?php _e( 'To change the password, please type the new one. Otherwise leave it blank.', 'supreme' ); ?></span>
		</p>
				
		<p>
			<label for="pass1"><?php _e( 'Enter Password Again', 'supreme' ); ?></label><br />
			<input type="password" name="pass2" id="pass2" size="16" value="" autocomplete="off" tabindex="<?php bbp_tab_index(); ?>" />
		</p>

		<div id="pass-strength-result"></div>
				
		<span class="description indicator-hint"><?php _e( 'Hint: The password should be at least seven characters long. To make it stronger, use upper and lower case letters, numbers and symbols like ! " ? $ % ^ &amp; ).', 'supreme' ); ?></span>

		<?php if ( !bbp_is_user_home() ) : ?>

		<p>
			<label for="role"><?php _e( 'Role:', 'supreme' ) ?></label><br />
		...
		<p>
			<label for="role"><?php _e( 'Super Admin', 'supreme' ); ?></label><br />
			...
			<span class="description"><?php _e( 'Grant this user super admin privileges for the Network.', 'supreme' ); ?></span>
		</p>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="button submit user-submit"><?php bbp_is_user_home() ? _e( 'Update Profile', 'supreme' ) : _e( 'Update User', 'supreme' ); ?></button>
		</div>
