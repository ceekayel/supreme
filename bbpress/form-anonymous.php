...
<?php if ( bbp_is_anonymous() || ( bbp_is_topic_edit() && bbp_is_topic_anonymous() ) || ( bbp_is_reply_edit() && bbp_is_reply_anonymous() ) ) : ?>
	...
	<?php do_action( 'bbp_theme_before_anonymous_form' ); ?>
		...
		<h3><?php ( bbp_is_topic_edit() || bbp_is_reply_edit() ) ? _e( 'Author Information', 'supreme' ) : _e( 'Your information:', 'supreme' ); ?></h3>

		<?php do_action( 'bbp_theme_anonymous_form_extras_top' ); ?>

		<p>
			<label for="bbp_anonymous_author"><?php _e( 'Name (required):', 'supreme' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php _e( 'Mail (will not be published) (required):', 'supreme' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php _e( 'Website:', 'supreme' ); ?></label><br />
